    ...
    return (
        <div className='flex flex-col md:flex-row p-6 space-y-6 md:space-y-0 md:space-x-6 bg-gray-600'>
            ...
            <div className='flex-1 flex flex-col items-start space-y-4'>
                ...
                <button onClick={handleServicesClick} className='px-4 py-2 text-white rounded-lg hover:bg-[rgb(251,175,68)]'>
                    Our Services
                </button>
            </div>
            ...
            <div className='flex-1 flex flex-col items-start space-y-4'>
                ...
                <button onClick={handleContactUsClick} className='px-4 py-2 text-white rounded-lg hover:bg-[rgb(251,175,68)]'>
                    Contact Us
                </button>
            </div>
